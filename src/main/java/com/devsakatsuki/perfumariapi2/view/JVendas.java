...
public class JVendas extends javax.swing.JFrame {
    ...
    private void initComponents() {
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(btnRemover, javax.swing.GroupLayout.DEFAULT_SIZE, 72, Short.MAX_VALUE)
                        .addGap(6, 6, 6)))
                .addContainerGap())
        );
        ...
        grupoPagamento.add(rdoCartao);
        rdoCartao.setText("Cartão Débito ou Crédito");

        grupoPagamento.add(rdoBoleto);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Vendas order = new Vendas();
        
        if(order.getQuantidadePedido()<product.getQuantidade()){
        JOptionPane.showMessageDialog(this, "A Perfumaria agradece a sua compra.\n"
            ...
            JOptionPane.showMessageDialog(this, "A quantidade inserida excede a quantidade do estoque!");
        }
